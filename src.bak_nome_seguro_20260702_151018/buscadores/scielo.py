...
def executar_busca_scielo(query, ano_inicial, ano_final, max_artigos=50):
    print("\nBuscando artigos no SciELO...")
    ...
    try:
        ...
        print(f"Aviso: nao foi possivel consultar SciELO automaticamente: {erro}")
        return []
    ...
    print(f"SciELO: {len(artigos)} registros encontrados.")
